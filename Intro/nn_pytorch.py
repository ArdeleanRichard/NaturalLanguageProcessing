...
from utils.constants import labels, device, train_file, test_file
from utils.data_agnews import MyDataset, get_split_data
...
if __name__ == '__main__':
    train_df, val_df, test_df, vocabulary_size = get_split_data(train_file, test_file)
